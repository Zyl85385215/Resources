...
LoginMenu::LoginMenu()
{
	...
	m_pFormChgPswd->GetComponent("zh")->SetCaption("输入6-16位数字或字母", 0);
	m_pFormChgPswd->GetComponent("laomima")->SetCaption("必填", 0);
	m_pFormChgPswd->GetComponent("mima")->SetCaption("必填", 0);
	m_pFormChgPswd->GetComponent("ma")->SetCaption("必填", 0);
