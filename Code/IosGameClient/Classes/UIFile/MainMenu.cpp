...
MainMenu::MainMenu()
{
	...
	m_pLifeStarSysMenu = new LifeStarSysMenu();
	TabMenuObj*	ppTabStar[2];
	ppTabStar[0] = m_pStarSysMenu;
	ppTabStar[1] = m_pLifeStarSysMenu;
	m_pStarTabCtrl = new TabMenuCtrl(ppTabStar, 2);
	...
	m_pFlappyBirdMenu = new FlappyBirdMenu();
...
MainMenu::~MainMenu()
{
	...
	delete m_pLifeStarSysMenu;
	delete m_pStarTabCtrl;
...
void MainMenu::Update()
{
	...
	m_pAchievementMenu1->Update();
	m_pAchievementMenu2->Update();
	m_pAchievementListMenu->Update();
	m_pMallMenu->Update();
	m_pShopMenu->Update();
