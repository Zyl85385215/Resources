...
{
	DWORD bufSize;
	char * szTemp = (char *)CCFileUtils::sharedFileUtils()->getFileData(CCFileUtils::sharedFileUtils()->fullPathForFilename(fileName).c_str(),"rb", &bufSize);
	if (szTemp == NULL)
		return NULL;
...
double yjgRandom(double start, double end)
{   
