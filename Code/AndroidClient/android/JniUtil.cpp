...
int JniUtil::getUnZipCnt()
{
	...
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getUnZipCnt","()I"); 
	if (isHave) { 
...
int JniUtil::getLoginStep()
{
	int b;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getLoginStep","()I"); 
	if (isHave) { 
		b=jmi.env->CallStaticIntMethod(jmi.classID,jmi.methodID);
	}
	return b;
...
int JniUtil::getLoginID()
{
	int b;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getLoginID","()I"); 
	if (isHave) { 
		b=jmi.env->CallStaticIntMethod(jmi.classID,jmi.methodID);
	}
	return b;
...
int JniUtil::getCenterType()
{
	int b = -1;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getCenterType","()I"); 
	if (isHave) { 
		b=jmi.env->CallStaticIntMethod(jmi.classID,jmi.methodID);
	}
	return b;
...
int JniUtil::getLockInUpdate()
{
	int b = 0;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getLockInUpdate","()I"); 
	if (isHave) { 
		b=jmi.env->CallStaticIntMethod(jmi.classID,jmi.methodID);
	}
	return b;
...
int JniUtil::getTPlatID()
{
	int b;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getTPID","()I"); 
	if (isHave) { 
		b=jmi.env->CallStaticIntMethod(jmi.classID,jmi.methodID);
	}
	return b;
...
char* JniUtil::getAndDevId()
{
	...
	jstring jstr;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getAndDevId","()Ljava/lang/String;"); 
	if (isHave) { 
...
char* JniUtil::getAndIDFA()
{
	...
	jstring jstr;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getAndIDFA","()Ljava/lang/String;"); 
	if (isHave) { 
		jstr=static_cast<jstring>(jmi.env->CallStaticObjectMethod(jmi.classID,jmi.methodID));
		char * tchar=(char*)jmi.env->GetStringUTFChars(jstr,0);
		strcpy(szRtl,tchar);
...
char* JniUtil::getLoginToken()
{
	...
	jstring jstr;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getLoginToken","()Ljava/lang/String;"); 
	if (isHave) { 
		jstr=static_cast<jstring>(jmi.env->CallStaticObjectMethod(jmi.classID,jmi.methodID));
		char * tchar=(char*)jmi.env->GetStringUTFChars(jstr,0);
		strcpy(szRtl,tchar);
...
//	jstring jstr;
//	JniMethodInfo jmi;//定义Jni函数信息结构体 
//	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getLoginID","()Ljava/lang/String;"); 
//	if (isHave) { 
//		jstr=static_cast<jstring>(jmi.env->CallStaticObjectMethod(jmi.classID,jmi.methodID));
//		char * tchar=(char*)jmi.env->GetStringUTFChars(jstr,0);
...
//	jstring jstr;
//	JniMethodInfo jmi;//定义Jni函数信息结构体 
//	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getLoginKey","()Ljava/lang/String;"); 
//	if (isHave) { 
//		jstr=static_cast<jstring>(jmi.env->CallStaticObjectMethod(jmi.classID,jmi.methodID));
//		char * tchar=(char*)jmi.env->GetStringUTFChars(jstr,0);
//		strcpy(pdeviceName,tchar);
...
char* JniUtil::getAndSDpath()
{
	...
	jstring jstr;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getSDPath","()Ljava/lang/String;"); 
	if (isHave) { 
		jstr=static_cast<jstring>(jmi.env->CallStaticObjectMethod(jmi.classID,jmi.methodID));
		char* tchar=(char*)jmi.env->GetStringUTFChars(jstr,0);
		strcpy(szRtl,tchar);
...
{
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","initResToSDCard","()V"); 
	if (isHave) { 
...
int JniUtil::goLogin()
{
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	int b = 0;
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","goLogin","()I"); 
	if (isHave) { 
		b	= jmi.env->CallStaticIntMethod(jmi.classID,jmi.methodID);
	}
	return b;
...
//{
//	JniMethodInfo jmi;//定义Jni函数信息结构体 
//	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","goBBS","(Ljava/lang/String;Ljava/lang/String;)V"); 
//	if (isHave) {
...
{
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","TPSubmitUser","(IIILjava/lang/String;Ljava/lang/String;)V"); 
	if (isHave) {
...
void JniUtil::goPay( int nVal,int nSvrId,char* szAcc, char* szOrder )
{
	int nRtl	= 0;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","goPay","(IILjava/lang/String;Ljava/lang/String;)V"); 
	if (isHave) {
...
{
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","goTpCenter","()V"); 
	if (isHave) { 
...
{
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","update","()V"); 
	if (isHave) { 
		jmi.env->CallStaticVoidMethod(jmi.classID,jmi.methodID);
	}
}
...
{
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","OtherEvent","(I)V"); 
	if (isHave) { 
...
//{
//	JniMethodInfo jmi;//定义Jni函数信息结构体 
//	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","TPResetVersionFile","()V"); 
//	if (isHave) { 
//		jmi.env->CallStaticVoidMethod(jmi.classID,jmi.methodID,nVal);
//	}
//}
...
char* JniUtil::TPOpenVersionUrl( char* szUrl,char* szOut )
{
	...
	int b = 0;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","TPOpenVersionUrl","(Ljava/lang/String;)Ljava/lang/String;"); 
	if (isHave) { 
...
int JniUtil::TPDownZipFile( char* szUrl,char* szSaveName )
{
	int b = 0;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","TPDownZipFile","(Ljava/lang/String;Ljava/lang/String;)I"); 
...
int JniUtil::TPUnZipFile( char* szName )
{
	int b = 0;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","TPUnZipFile","(Ljava/lang/String;)I"); 
	if (isHave) { 
...
int JniUtil::getSystemVersion()
{
	int b;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getSystemVersion","()I"); 
	if (isHave) { 
		b=jmi.env->CallStaticIntMethod(jmi.classID,jmi.methodID);
	}
	return b;
...
char* JniUtil::getMacAddress()
{
	...
	jstring jstr;
	JniMethodInfo jmi;//定义Jni函数信息结构体 
	bool isHave = JniHelper::getStaticMethodInfo(jmi,"com/mejoygame/rpgwar/yyh/RpgWar","getMacAddress","()Ljava/lang/String;"); 
	if (isHave) { 
		jstr=static_cast<jstring>(jmi.env->CallStaticObjectMethod(jmi.classID,jmi.methodID));
		char * tchar=(char*)jmi.env->GetStringUTFChars(jstr,0);
		strcpy(szRtl,tchar);
