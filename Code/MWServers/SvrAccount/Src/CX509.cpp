...
CX509::CX509(void)
{
	...
	m_exOpr[0].lpDoEnde = &CX509::DoPublicKeyEncryption;
	m_exOpr[0].key = &m_public_key;
	m_exOpr[0].key_size = &m_public_key_size;

	m_exOpr[1].lpDoEnde = &CX509::DoPublicKeyDecryption;
	m_exOpr[1].key = &m_public_key;
	m_exOpr[1].key_size = &m_public_key_size;

	m_exOpr[2].lpDoEnde = &CX509::DoPrivateKeyEncryption;
	m_exOpr[2].key = &m_private_key;
	m_exOpr[2].key_size = &m_private_key_size;

	m_exOpr[3].lpDoEnde = &CX509::DoPrivateKeyDecryption;
	m_exOpr[3].key = &m_private_key;
	m_exOpr[3].key_size = &m_private_key_size;
}

CX509::CX509(unsigned int key_size)
{
	if(key_size == 0)
		m_bits = DEFAULT_KEY_SIZE;
	else
...
BOOL CX509::DoEnde(const unsigned char *from,int from_size,unsigned char *to,int to_size,int nFlag)
{
...
BOOL CX509::DoEnde(const unsigned char *key,int key_size,const unsigned char *from,int from_size,unsigned char *to,int to_size,int nFlag)
{
	if( nFlag != 0 &&
		nFlag != 1 &&
		nFlag != 2 &&
...
void CX509::SetPublicKey(const unsigned char *key,unsigned int key_size)
{
	if(key)
	{
...
void CX509::SetPrivateKey(const unsigned char *key,unsigned int key_size)
{
	if(key)
	{
...
unsigned int CX509::GetPublicKey(unsigned char **key)
{
	if(NULL == key)
		return 0;
...
unsigned int CX509::GetPrivateKey(unsigned char **key)
{
	if(NULL == key)
		return 0;
...
int CX509::DoPublicKeyEncryption(const unsigned char *key,int key_size,const unsigned char *from,int from_size,unsigned char *to,int to_size)
{
	int					padding;
...
int CX509::DoPublicKeyDecryption(const unsigned char *key,int key_size,const unsigned char *from,int from_size,unsigned char *to,int to_size)
{
	int					padding;
	int					fsurlen,to_count,flen;
	int					result;
...
int CX509::DoPrivateKeyEncryption(const unsigned char *key,int key_size,const unsigned char *from,int from_size,unsigned char *to,int to_size)
{
	int					padding;
	int					fsurlen,to_count,flen;
	int					result;
...
int CX509::DoPrivateKeyDecryption(const unsigned char *key,int key_size,const unsigned char *from,int from_size,unsigned char *to,int to_size)
{
	int					padding;
	int					fsurlen,to_count,flen;
	int					result;
